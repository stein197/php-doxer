...
```php
$doc = new Stein197\Doxer\Doc('/** @return string A string */');
$doc->getDescription(); // "A string"
$doc->getTags(); // [['type' => 'string']]
```
...
```php
$doc = new Stein197\Doxer\Doc('/** @nonexistent string A string */');
$doc->getDescription(); // "string A string"
$doc->getTags(); // null
```
